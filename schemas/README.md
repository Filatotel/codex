...
| `EXECUTION_ROUTE` | exact draft/final result identity, three mandatory role segments, at least two ordered handoffs, unique capability requirements; profile resolution and subset/equivalence checks are semantic gates |
